...
show_banner() {
    ...
    echo -e "    \033[1;33m$l1\033[0m"
    echo -e "    \033[1;31m$l2\033[0m"
    echo -e "    \033[1;37m$l3\033[0m"
    echo -e "    \033[1;31m$l4\033[0m"
    echo -e "    \033[1;37m$l5\033[0m"
    echo -e "    \033[1;34m$l6\033[0m"
    echo -e "    \033[1;34m$l7\033[0m"
    echo -e "    \033[1;36m$l8\033[0m"
    echo ""
